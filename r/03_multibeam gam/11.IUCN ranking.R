...
write.csv(fished.species, file = "plots/multibeam gamms/swc.fished.species.csv", row.names = F)
...
write.csv(iucn.species, file = "plots/multibeam gamms/swc.iucn.species.csv", row.names = F)
